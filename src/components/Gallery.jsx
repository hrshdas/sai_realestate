...
const galleryImages = [
    ...
    { src: '/images/construction-site-2.jpg', label: 'Site Progress', location: 'New Delhi' },
    { src: '/images/construction-site-3.jpg', label: 'Building Structure', location: 'New Delhi' },

    { src: '/images/rebar-construction.jpg', label: 'Structural Framework', location: 'New Delhi' },
    { src: '/images/interior-living.jpg', label: 'Luxury Interior', location: 'New Delhi' },
    { src: '/images/interior-lounge.jpg', label: 'Premium Lounge', location: 'New Delhi' },
    { src: '/images/interior-dining.jpg', label: 'Elegant Dining', location: 'New Delhi' },
    { src: '/images/interior-sitting.jpg', label: 'Designer Sitting Room', location: 'New Delhi' },
    { src: '/images/interior-corridor.jpg', label: 'Grand Corridor', location: 'New Delhi' },
    ...
    { src: '/images/interior-marble2.jpg', label: 'Modern TV Unit', location: 'New Delhi' },
    { src: '/images/interior-bedroom.jpg', label: 'Signature Bedroom', location: 'New Delhi' },
    { src: '/images/interior-bedroom2.jpg', label: 'Botanical Bedroom Suite', location: 'New Delhi' },
